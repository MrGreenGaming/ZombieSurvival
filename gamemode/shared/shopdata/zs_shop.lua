...
shopData = {
	...
	[2] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "If you wear this, you'll look like that anime character,Kanti Sama.", Key = "monitor", ID = 2, Sell = 0, Requires = 0, Name = "TV Head",  },
	...
	[7] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "Time to hit a homerun! All you need is a headcrab and a crowbar...", Key = "ushat", ID = 7, Sell = 0, Requires = 0, Name = "Baseball cap",  },
--	[8] = { Cost = 5000, Hidden = true, AdminOnly = false, Desc = "Human spines are like toothpicks to you. Do more damage when attacking a human from behind!", Key = "backbreaker", ID = 8, Sell = 0, Requires = 0, Name = "Backbreaker",  },
	...
	[10] = { Cost = 250, Type = "hat", AdminOnly = false, Desc = "Easter eggs. Lol.", Key = "bunnyears", ID = 10, Sell = 0, Requires = 0, Name = "Bunny Ears",  },
	...
	[13] = { Cost = 250, Type = "hat", AdminOnly = false, Desc = "You might experience a little IQ increase when inserting this thing in your head. Don't count on it though.", Key = "borghat", ID = 13, Sell = 0, Requires = 0, Name = "Borg hat",  },
	...
	[15] = { Cost = 150, Type = "hat", AdminOnly = false, Desc = "With this big eye-catching thing lodged on your head you're sure to attract some attention. Too bad it doesn't shoot lasers.", Key = "roboteye", ID = 15, Sell = 0, Requires = 0, Name = "Robot hat",  },
	...
	[18] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "Ho ho ho! Merry Christmas! It's that time of the year again .. (Permanent hat)", Key = "snowhat", ID = 18, Sell = 0, Requires = 0, Name = "Snowman Hat",  },
	[19] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "Greencoins make Santa Claus's World go round! That's why you should buy this lovely hat right from Santa's Bag!  .. (Permanent hat)", Key = "present", ID = 19, Sell = 0, Requires = 0, Name = "Present Hat",  },
	[20] = { Cost = 250, Type = "hat", AdminOnly = false, Desc = "A sawblade sombrero, how cool can it get? Chuck Norris has one you know.", Key = "sombrero", ID = 20, Sell = 0, Requires = 0, Name = "Sombrero",  },
	[21] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "You won't die of starvation with this thing on.", Key = "melonhead", ID = 21, Sell = 0, Requires = 0, Name = "Melonhead",  },
	[22] = { Cost = 8000,Type = "misc", AdminOnly = false, Desc = "+50% ammunition from SkillShop and mobile supply crates!", Key = "ammoman", ID = 22, Sell = 0, Requires = 0, Name = "Ammunition Man",  },
	...
	[30] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "A cooking pot is THE perfect household head protection when fighting anything unnatural!", Key = "pothat", ID = 30, Sell = 0, Requires = 0, Name = "Pot hat",  },
	...
	[33] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "Christmas, it's that time of the year again!", Key = "santahat", ID = 33, Sell = 0, Requires = 0, Name = "Santa hat",  },
	[34] = { Cost = 5000, Type = "misc", AdminOnly = false, Desc = "You will feel luckier with dice rolls!", Key = "ladyluck", ID = 34, Sell = 0, Requires = 0, Name = "Lady Luck",  },
	...
	[36] = { Cost = 500, Type = "hat", AdminOnly = false, Desc = "You'd be Nicolas Cage - Death Rider with this hat on!", Key = "skull", ID = 36, Sell = 0, Requires = 0, Name = "Skull Hat",  },
	...
	[38] = { Cost = 250, Type = "hat", AdminOnly = false, Desc = "Pirates are the mortal enemy of ninjas, but they love to pick off a zombie on their way.", Key = "piratehat", ID = 38, Sell = 0, Requires = 0, Name = "Pirate hat",  },
	[39] = { Cost = 250, Type = "hat", AdminOnly = false, Desc = "Raises your intelligence-aura by 100%! Note that it does not scare off zombies.", Key = "tophat", ID = 39, Sell = 0, Requires = 0, Name = "Top hat",  },
	[40] = { Cost = 200, Type = "hat", AdminOnly = false, Desc = "Bring some old-fashioned style to the apocalypse. Probably stolen from a dead Brit.", Key = "homburg", ID = 40, Sell = 0, Requires = 0, Name = "Homburg hat",  },
	[41] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "A bucket hat. Works better than kevlar according to the local bums.", Key = "buckethat", ID = 41, Sell = 0, Requires = 0, Name = "Bucket hat",  },
	...
	[43] = { Cost = 6500, Type = "misc", Hidden = false, AdminOnly = false, Desc = "Bring more destruction! You will deal 50% more damage to nailed props.", Key = "cadebuster", ID = 43, Sell = 0, Requires = 0, Name = "Cade Buster",  },
	[44] = { Cost = 7000, Type = "misc", AdminOnly = false, Desc = "40% decreased fall damage as a human.", Key = "bootsofsteel", ID = 44, Sell = 0, Requires = 0, Name = "Boots of Steel",  },
	...
	[47] = { Cost = 1, Type = "suit", AdminOnly = true, Desc = "Special suit just for admins!", Key = "greenssuit", ID = 47, Sell = 0, Requires = 0, Name = "Admin's Suit",  },
	
	[53] = { Cost = 1600, Type = "other", AdminOnly = false, Desc = "It glows!", Key = "techeyes", ID = 53, Sell = 0, Requires = 0, Name = "Techno Eyes" },
	[54] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "What the... How the hell you are still alive with that thing in your head?!", Key = "cleaver", ID = 54, Sell = 0, Requires = 0, Name = "Nasty Cleaver" },
	[55] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "Augmentations ftw. However this hat will not increase your accuracy :O", Key = "magnlamp", ID = 55, Sell = 0, Requires = 0, Name = "Magnifying lamp" },
	[56] = { Cost = 150, Type = "hat", AdminOnly = false, Desc = "It HUNGERS for more!", Key = "scannerhelm", ID = 56, Sell = 0, Requires = 0, Name = "Scanner Helmet" },
	...
	[58] = { Cost = 200, Type = "hat", AdminOnly = false, Desc = "'I love the smell of cooked zombies in the morning!'", Key = "chef", ID = 58, Sell = 0, Requires = 0, Name = "Chef's Hat" },
	[59] = { Cost = 200, Type = "hat", AdminOnly = false, Desc = "Picking up cans since 2008", Key = "combinehelm", ID = 59, Sell = 0, Requires = 0, Name = "Combine Helmet" },
	[60] = { Cost = 100, Type = "other", AdminOnly = false, Desc = "Looks like it was ripped off straight from Vaporizer Rifle... Or not?", Key = "termeye", ID = 60, Sell = 0, Requires = 0, Name = "Technology!" },
	[61] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "A cute fez for your and your friends :O  (NOTE: Actually it is red by default, but preview aint showing it)", Key = "fez", ID = 61, Sell = 0, Requires = 0, Name = "Tiny Fez" },
	[62] = { Cost = 500, Type = "other", AdminOnly = false, Desc = "ARE YOU MANLY ENOUGH TO WEAR THIS BEARD?! (Requires TF2)", Key = "beard", ID = 62, Sell = 0, Requires = 0, Name = "Beard" },
	[63] = { Cost = 500, Type = "other", AdminOnly = false, Desc = "Remember, smoking kills (zombies). (Requires TF2)", Key = "cigar", ID = 63, Sell = 0, Requires = 0, Name = "Cigar" },
	...
	[65] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "Now that is a proper hat for zombie apocalypse. (Requires TF2)", Key = "hellsing", ID = 65, Sell = 0, Requires = 0, Name = "Hellsing Hat" },
	[66] = { Cost = 100, Type = "hat",Hidden = true, AdminOnly = false, Desc = "You're tought guy, huh?. (Requires TF2)", Key = "beanie", ID = 66, Sell = 0, Requires = 0, Name = "Beanie" },
	[67] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "Just a normal hat. Nothing special... right?. (Requires TF2)", Key = "normalhat", ID = 67, Sell = 0, Requires = 0, Name = "Ordinary Hat" },
	[68] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "At least everyone will know who you are. (Requires TF2)", Key = "medhelm", ID = 68, Sell = 0, Requires = 0, Name = "Medic's Helmet" },
	
	[70] = { Cost = 150, Type = "hat", AdminOnly = false, Desc = "Classic cap for winter apocalypse. (Requires TF2)", Key = "wintercap", ID = 70, Sell = 0, Requires = 0, Name = "Winter Cap" },
	[71] = { Cost = 200, Type = "hat", AdminOnly = false, Desc = "...and so stylish!. (Requires TF2)", Key = "socold", ID = 71, Sell = 0, Requires = 0, Name = "Im so cold..." },
	...
	[73] = { Cost = 200, Type = "hat", AdminOnly = false, Desc = "I love extreme stuff. (Requires TF2)", Key = "skihat", ID = 73, Sell = 0, Requires = 0, Name = "Ski Hat" },
	[74] = { Cost = 500, Type = "hat", AdminOnly = false, Desc = "Pimp?. (Requires TF2)", Key = "hall", ID = 74, Sell = 0, Requires = 0, Name = "Hustler's Hallmark" },
	[75] = { Cost = 500, Type = "other", AdminOnly = false, Desc = "Just a pair of cool glasses, I guess?. (Requires TF2)", Key = "copgl", ID = 75, Sell = 0, Requires = 0, Name = "Cop Glasses" },
	[76] = { Cost = 100, Type = "other", AdminOnly = false, Desc = "Sometimes you just need a little more hair. (Requires TF2)", Key = "sidebrn", ID = 76, Sell = 0, Requires = 0, Name = "Sideburns" },
	[77] = { Cost = 100, Type = "other", AdminOnly = false, Desc = "Swag with burgers for ears, and guns for brains!", Key = "BurgerBuns", ID = 77, Sell = 0, Requires = 0, Name = "BurgerBuns" },
	[78] = { Cost = 100, Type = "other", AdminOnly = false, Desc = "Becoming a cyborg is fun.", Key = "RoboEars", ID = 78, Sell = 0, Requires = 0, Name = "RoboEars" },
	[79] = { Cost = 100, Type = "other", AdminOnly = false, Desc = "Being chased by zombies! No problem, attach this and play away! 'Doesn't actually do that'.", Key = "Helihead", ID = 79, Sell = 0, Requires = 0, Name = "HeliHead" },
	
	[84] = { Cost = 200, Type = "hat", AdminOnly = false, Desc = "I see you!", Key = "spotlight", ID = 84, Sell = 0, Requires = 0, Name = "Spotlight",  },
	[85] = { Cost = 200 , Type = "hat", AdminOnly = false, Desc = "Brum Brum beep beep outa my way you Kliener scum!", Key = "motorhead", ID = 85, Sell = 0, Requires = 0, Name = "Motor Head",  },
	[86] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "I will never fall over! 'You will still have the fall down animation.'", Key = "gyrohead", ID = 86, Sell = 0, Requires = 0, Name = "Gyro Head",  },
	[87] = { Cost = 150, Type = "hat", AdminOnly = false, Desc = "Let there be light", Key = "brightidea", ID = 87, Sell = 0, Requires = 0, Name = "Bright Idea",  },
	[88] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "Lamps", Key = "lampshade", ID = 88, Sell = 0, Requires = 0, Name = "Lamp Shade",  },
	...
	[90] = { Cost = 200, Type = "hat", AdminOnly = false, Desc = "A drunken night with Reiska is fun.", Key = "roadlock", ID = 90, Sell = 0, Requires = 0, Name = "Road Lock",  },
	[91] = { Cost = 150, Type = "hat", AdminOnly = false, Desc = "A shield against your head getting bitten off!", Key = "combinething", ID = 91, Sell = 0, Requires = 0, Name = "The Combine Thing",  },
	[92] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "Blame Pufulet", Key = "fence", ID = 92, Sell = 0, Requires = 0, Name = "Da fence",  },
	[93] = { Cost = 200, Type = "hat", AdminOnly = false, Desc = "Jiggle Jiggle", Key = "noveltyhead", ID = 93, Sell = 0, Requires = 0, Name = "Novelty Head 1",  },
	[94] = { Cost = 200, Type = "hat", AdminOnly = false, Desc = "Boggle boggle", Key = "noveltyhead2", ID = 94, Sell = 0, Requires = 0, Name = "Novelty Head 2",  },
	[95] = { Cost = 100, Type = "hat", AdminOnly = false, Desc = "I am like valve but better! ^^", Key = "steamhead", ID = 95, Sell = 0, Requires = 0, Name = "Steam Head",  },
	...
	[50] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "[REQUIRES ENGINEER] | +1 turret damage | +30 turret and mini turret ammo capacity | +20% turret and mini turret damage resistance | +10% C4 damage | suit does not need to be equipped for bonuses.", Key = "techsuit", ID = 50, Sell = 0, Requires = 0, Name = "Engineer's Suit",  },
	[51] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "[REQUIRES SUPPORT] | +5 starting hammer nails | +2 hammer repair points | +20 nail health | suit does not need to be equipped for bonuses.", Key = "supportsuit", ID = 51, Sell = 0, Requires = 0, Name = "Support's Suit",  },
	[52] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "[REQUIRES COMMANDO] | +50% grenade damage | +20% clip size | suit does not need to be equipped for bonuses. ", Key = "assaultsuit", ID = 52, Sell = 0, Requires = 0, Name = "Commando's Suit",  },
	[69] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "[REQUIRES SHARPSHOOTER] | +5% headshot damage | 20% chance to evade claw damage | suit does not need to be equipped for bonuses. ", Key = "stalkersuit", ID = 69, Sell = 0, Requires = 0, Name = "Sharpshooter's Suit" },
	[80] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "[REQUIRES BERSERKER] | +5 health gained from melee kills | suit does not need to be equipped for bonuses.", Key = "gravedigger", ID = 80, Sell = 0, Requires = 0, Name = "Berserker's Suit",  },
	[111] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "[REQUIRES PYRO] | +1 second burn time | +5% chance to burn target | +15% scorch damage | suit does not need to be equipped for bonuses.", Key = "pyrosuit", ID = 111, Sell = 0, Requires = 0, Name = "Pyro's Suit",  },
