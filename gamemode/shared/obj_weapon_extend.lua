...
PlayerModelBones["ValveBiped.Bip01_L_Finger42"] 	= {CSSBone = "v_weapon.Left_Pinky03",Finger = true,CSSAngle=Angle(0,-40,0)}
PlayerModelBones["ValveBiped.Bip01_L_Finger3"] 		= {CSSBone = "v_weapon.Left_Ring01",Finger = true,CSSAngle=Angle(0,-30,0)}
PlayerModelBones["ValveBiped.Bip01_L_Finger31"] 	= {CSSBone = "v_weapon.Left_Ring02",Finger = true,CSSAngle=Angle(0,-40,0)}
PlayerModelBones["ValveBiped.Bip01_L_Finger32"] 	= {CSSBone = "v_weapon.Left_Ring03",Finger = true,CSSAngle=Angle(0,-40,0)}
PlayerModelBones["ValveBiped.Bip01_L_Finger2"] 		= {CSSBone = "v_weapon.Left_Middle01",Finger = true,CSSAngle=Angle(0,-30,0)}
PlayerModelBones["ValveBiped.Bip01_L_Finger21"] 	= {CSSBone = "v_weapon.Left_Middle02",Finger = true,CSSAngle=Angle(0,-40,0)}
PlayerModelBones["ValveBiped.Bip01_L_Finger22"] 	= {CSSBone = "v_weapon.Left_Middle03",Finger = true,CSSAngle=Angle(0,-40,0)}
PlayerModelBones["ValveBiped.Bip01_L_Finger1"] 		= {CSSBone = "v_weapon.Left_Index01",Finger = true,CSSAngle=Angle(0,-30,0)}
PlayerModelBones["ValveBiped.Bip01_L_Finger11"] 	= {CSSBone = "v_weapon.Left_Index02",Finger = true,CSSAngle=Angle(0,-40,0)}
PlayerModelBones["ValveBiped.Bip01_L_Finger12"] 	= {CSSBone = "v_weapon.Left_Index03",Finger = true,CSSAngle=Angle(0,-40,0)}
PlayerModelBones["ValveBiped.Bip01_L_Finger0"] 		= {CSSBone = "v_weapon.Left_Thumb01",Finger = true,CSSAngle=Angle(0,10,0)}
PlayerModelBones["ValveBiped.Bip01_L_Finger01"] 	= {CSSBone = "v_weapon.Left_Thumb_02",Finger = true,CSSAngle=Angle(0,10,0)}
PlayerModelBones["ValveBiped.Bip01_L_Finger02"] 	= {CSSBone = "v_weapon.Left_Thumb03",Finger = true}
---------------------------
...
PlayerModelBones["ValveBiped.Bip01_R_Finger3"] 		= {CSSBone = "v_weapon.Right_Ring01", Finger = true,CSSAngle=Angle(0,-10,0)}
PlayerModelBones["ValveBiped.Bip01_R_Finger31"] 	= {CSSBone = "v_weapon.Right_Ring02", Finger = true,CSSAngle=Angle(0,-10,0)}
PlayerModelBones["ValveBiped.Bip01_R_Finger32"] 	= {CSSBone = "v_weapon.Right_Ring03", Finger = true,CSSAngle=Angle(0,-5,0)}
PlayerModelBones["ValveBiped.Bip01_R_Finger2"] 		= {CSSBone = "v_weapon.Right_Middle01", Finger = true,CSSAngle=Angle(0,-10,0)}
PlayerModelBones["ValveBiped.Bip01_R_Finger21"] 	= {CSSBone = "v_weapon.Right_Middle02", Finger = true,CSSAngle=Angle(0,-10,0)}
PlayerModelBones["ValveBiped.Bip01_R_Finger22"] 	= {CSSBone = "v_weapon.Right_Middle03", Finger = true,CSSAngle=Angle(0,-5,0)}
PlayerModelBones["ValveBiped.Bip01_R_Finger1"] 		= {CSSBone = "v_weapon.Right_Index01", Finger = true,CSSAngle=Angle(0,-10,0)}
PlayerModelBones["ValveBiped.Bip01_R_Finger11"] 	= {CSSBone = "v_weapon.Right_Index02", Finger = true,CSSAngle=Angle(0,-10,0)}
PlayerModelBones["ValveBiped.Bip01_R_Finger12"] 	= {CSSBone = "v_weapon.Right_Index03", Finger = true,CSSAngle=Angle(0,-5,0)}
PlayerModelBones["ValveBiped.Bip01_R_Finger0"] 		= {CSSBone = "v_weapon.Right_Thumb01", Finger = true,CSSAngle=Angle(0,0,0)}
PlayerModelBones["ValveBiped.Bip01_R_Finger01"] 	= {CSSBone = "v_weapon.Right_Thumb02",Finger = true,CSSAngle=Angle(0,0,0)}
PlayerModelBones["ValveBiped.Bip01_R_Finger02"] 	= {CSSBone = "v_weapon.Right_Thumb03", Finger = true,CSSAngle=Angle(0,0,0)}
