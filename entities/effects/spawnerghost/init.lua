...
function EFFECT:Think()
	if not IsValid(self.EfOwner) or not IsValid(self.EfOwner:GetActiveWeapon()) or self.EfOwner:GetActiveWeapon():GetClass() ~= "weapon_zs_tools_spawner" or not self.EfOwner:Alive() or not self.EfOwner:IsHuman() then
		return false
	end
