...
ZombieClasses[1] =		--I re-added this class to add some diversity into the game. We need faster classes				
{
	...
	Speed = 148,	
	AngleFix = true,
	DescriptionGameplay = { "> PRIMARY: Claws", "> SECONDARY: Throw flesh","> RELOAD: Create blood spawner on ground", "> FLESH: 10 health to zombies, 5 damage to props and humans", "> CLAW POISON: 10 | 2 per 1.5 seconds", "> HEALTH: 130 ", "> SPEED: 148", "> DAMAGE: 15" },
	DescriptionGameplay2 = { "TYPE: Back bone of a horde! " },
	PainSounds = {
