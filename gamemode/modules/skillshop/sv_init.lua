...
local MaxItems = CreateConVar("zs_skillshop_sale_maxitems", "3", {}, "")
local MinDiscountRange = CreateConVar("zs_skillshop_sale_mindiscount", "5", {}, "")
local MaxDiscountRange = CreateConVar("zs_skillshop_sale_maxdiscount", "15", {}, "")
