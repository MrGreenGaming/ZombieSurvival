...
SWEP.VElements = {
	...
	["PyroShotgun5"] = { type = "Model", model = "models/props_trainstation/pole_448Connection002b.mdl", bone = "v_weapon.magazine", rel = "", pos = Vector(0, 1.904, 0), angle = Angle(0, 0, -99.003), size = Vector(0.07, 0.126, 0.009), color = Color(255, 255, 255, 255), surpresslightning = false, material = "carpet/offflra", skin = 0, bodygroup = {} },
