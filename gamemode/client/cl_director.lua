	...
	if BOSSACTIVE then
		...
		timer.Simple(0.5, function()
			...
			if bossPl and IsValid(bossPl) then		
				...
				GAMEMODE:Add3DMessage(140, bossPl:Name() .." has risen as ".. ZombieClasses[bossPl:GetZombieClass()].Name, nil, "ssNewAmmoFont7")
			end
		end)
...
local function ManageChatTitles ( pl, Text, TeamOnly, PlayerIsDead )
	...
	if pl.DataTable["Achievements"][12] == true then
