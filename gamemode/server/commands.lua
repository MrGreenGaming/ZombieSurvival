...
function RollTheDice ( pl,commandName,args )
	...
	elseif pl:Team() == TEAM_UNDEAD then
		choise = math.random(1,3)
		if pl:HasBought("ladyluck") and choise <= 2 then
			choise = math.random(2,3) -- second chance with bad outcome
		end
		message = ""
		name = pl:GetName()
...
local weaponList = { "weapon_zs_annabelle","weapon_zs_turretplacer","weapon_zs_shotgun","weapon_zs_syringe","weapon_zs_melee_crowbar", "weapon_zs_usp", "weapon_zs_p228", "weapon_zs_combatknife",       -- list all weapons you can give
...
"weapon_zs_m3super90", "weapon_zs_m1014", "weapon_zs_m249","weapon_zs_mine", "weapon_zs_sg552", "weapon_zs_famas", 
"weapon_zs_pulserifle", "weapon_zs_melee_keyboard", "weapon_zs_melee_pot", "weapon_zs_melee_axe", "weapon_zs_melee_keyboard", "weapon_zs_melee_fryingpan", "weapon_zs_tools_hammer", "weapon_zs_melee_plank","weapon_zs_boomstick","weapon_zs_melee_combatknife"} 
...
local function AdminSay( pl, text, teamonly )
	...
	if (#sep > 1 and text:sub(1,1) == "!") then
		...
		if(sep[1] == "!mute") then	
			...
			target:Mute()
			PrintMessageAll( HUD_PRINTTALK, "Admin "..pl:Name().." muted/unmuted player "..tostring( target:Name() ).."!" )
			return ""
		end
		...
		if(sep[1] == "!gag") then	
			...
			target:Gag()
			PrintMessageAll( HUD_PRINTTALK, "Admin "..pl:Name().." gagged/ungagged player "..tostring( target:Name() ).."!" )
			return ""
		end
