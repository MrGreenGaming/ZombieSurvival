...
function SWEP:InitializeClientsideModels()
	...
	self.VElements = {
		["chem1"] = { type = "Model", model = "models/props_junk/garbage_plasticbottle003a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.8, 2.2, -0.9), angle = Angle(0.688, -4.676, 180.695), size = Vector(0.5, 0.5, 0.5), color = Color(160, 160, 160, 255), surpresslightning = false, material = "phoenix_storms/stripes", skin = 0, bodygroup = {} }
	}
	
	self.WElements = {
		["chem1"] = { type = "Model", model = "models/props_junk/garbage_plasticbottle003a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.474, 1.949, -0.838), angle = Angle(-37.957, -115.47, 180.583), size = Vector(0.744, 0.744, 0.744), color = Color(255, 255, 255, 255), surpresslightning = false, material = "phoenix_storms/stripes", skin = 0, bodygroup = {} }
	}
end
...
local owner = self.Owner
	if SERVER then
		local ent = ents.Create("projectile_zsfirenade")
		if IsValid(ent) then
...
if CLIENT then
	...
	function SWEP:DrawHUD()
		...
		local texty = y + hei/2 
		 ...
		 draw.SimpleText("Fire Grenade", "ssNewAmmoFont7", x+space, texty+10, Color(255,255,255,255), TEXT_ALIGN_LEFT)
		 draw.SimpleText("Set Zombie's Alight! ", "ssNewAmmoFont7", x+space, texty-10, Color(255,255,255,255), TEXT_ALIGN_LEFT)
