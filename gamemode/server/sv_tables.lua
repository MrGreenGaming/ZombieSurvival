...
table.insert(ResourceFiles, "materials/zombiesurvival/humanclass/avatar_sharpshooter.vtf")
table.insert(ResourceFiles, "materials/zombiesurvival/humanclass/avatar_sharpshooter.vmt")
