...
shopData = {
	...
	[44] = { Cost = 12000, Type = "misc", AdminOnly = false, Desc = "Screw the gravity! You have a 1 in 3 chance of not taking fall damage! :O 'Testing price!'", Key = "bootsofsteel", ID = 44, Sell = 0, Requires = 0, Name = "Boots of Steel (Retro)",  },
