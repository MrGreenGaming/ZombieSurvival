...
SWEP.ModelOBB = { [1] = { Min = Vector( -5.2500, -25.2500, -18.4771 ) , Max = Vector ( 5.2500 ,15.0245 ,18.2500 )  }, [2] = { Min = Vector( -13.2614 ,-12.0523 ,-20.2876 ) , Max = Vector ( 13.2614, 12.0523 ,20.3897 )  } }
...
function SWEP:PrimaryAttack()
	if self:CanPrimaryAttack() then
		...
		local tr = util.TraceLine( { start = shootpos, endpos = shootpos + aimvec * 60, filter = self.Owner , mask = MASK_NPCWORLDSTATIC } )
