...
GM.HumanWeapons = {	
	...
	["weapon_zs_sg550"]  = { Name = "SG550", DPS = 106,Mat = "VGUI/gfx/VGUI/sg550", Infliction = 0.51, Type = "misc", Price = 1100 },
	...
	["weapon_zs_python"]  = { Name = "Python", DPS = 143, Infliction = 0, Type = "pistol", Price = 120 },
