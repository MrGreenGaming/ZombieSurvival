...
ZombieClasses[1] =		--I re-added this class to add some diversity into the game. We need faster classes				
{
	...
	Speed = 170,	
	AngleFix = true,
	DescriptionGameplay = { "> PRIMARY: Claws", "> SECONDARY: Throw flesh","> RELOAD: Create blood spawner on ground", "> FLESH: 10 health to zombies, 5 damage to props and humans", "> HEALTH: 140 ", "> SPEED: 170", "> DAMAGE: 17" },
	DescriptionGameplay2 = { "TYPE: Back bone of a horde! " },
	PainSounds = {
...
ZombieClasses[5] =
{
	...
	DescriptionGameplay = {"> PRIMARY: Hooks", "> SECONDARY: Teleport", "> HEALTH: 110 ", "> SPEED: 192", "> DAMAGE: 33" },
	DescriptionGameplay2 = {"TYPE: Support class for horde"},
	PainSounds = {
		--[[Sound("npc/stalker/stalker_pain1.wav"),
		Sound("npc/stalker/stalker_pain2.wav"),
...
ZombieClasses[6] =						
{
	...
	DescriptionGameplay = {"> PRIMARY: Girly claws", "> SECONDARY: Disorientating scream", "> HEALTH: 135 ", "> SPEED: 145", "> CLAW DAMAGE: 17" },
	DescriptionGameplay2 = { "TYPE: Support class for horde" },
	PlayerFootstep = true,
	AttackSounds = { 
