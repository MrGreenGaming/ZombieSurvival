...
--	[8] = { Cost = 5000, Hidden = true, AdminOnly = false, Desc = "Human spines are like toothpicks to you. Do more damage when attacking a human from behind!", Key = "backbreaker", ID = 8, Sell = 0, Requires = 0, Name = "Backbreaker",  },
	...
	[51] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "+5 starting hammer nails | +2 hammer repair points | +50% nail health ", Key = "supportsuit", ID = 51, Sell = 0, Requires = 0, Name = "Support's Suit",  },
	...
	[80] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "+5 health gained from melee kills", Key = "gravedigger", ID = 80, Sell = 0, Requires = 0, Name = "Berserker's Rage",  },
