...
--RequiresWeapon = What Human Class does the perk require to be shown
	...
	["_commando"] = {Name = "Commando",   		Equipment = "Grenades  |   Five SeveN   | Knife               ", Description = "See Undead Health | Extra Health | Extra Rifle Damage | Increased Clip Size | Faster Fire Rate |", Material = "zombiesurvival/humanclass/avatar_marksman", Slot = 3},
