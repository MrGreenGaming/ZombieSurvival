...
--	[8] = { Cost = 5000, Hidden = true, AdminOnly = false, Desc = "Human spines are like toothpicks to you. Do more damage when attacking a human from behind!", Key = "backbreaker", ID = 8, Sell = 0, Requires = 0, Name = "Backbreaker",  },
	...
	[50] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "If shooting zombies aint enough - use more gun. Suit Bonus: Turret damage is increased by 25%!", Key = "techsuit", ID = 50, Sell = 0, Requires = 0, Name = "Engineer Suit",  },
	[51] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "If you've mastered cading skills - this suit is for you. Suit Bonus: More nail HP, more nails at one time.", Key = "supportsuit", ID = 51, Sell = 0, Requires = 0, Name = "Support Suit",  },
	[52] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "Nothing feels better than killing zombies over and over again. Suit Bonus: Increased grenade damage/radius", Key = "assaultsuit", ID = 52, Sell = 0, Requires = 0, Name = "Commando Suit",  },
	[69] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "'You can run, but you can't hide!'. Suit bonus: Hides your heartbeat when standing still.", Key = "stalkersuit", ID = 69, Sell = 0, Requires = 0, Name = "Sharpshooter Suit" },
	[80] = { Cost = 9000, Type = "suit", AdminOnly = false, Desc = "You love zerking well this is the suit for you!! Gain hp for every melee kill depending on the weapon. ", Key = "gravedigger", ID = 80, Sell = 0, Requires = 0, Name = "Berserker Rage",  },
