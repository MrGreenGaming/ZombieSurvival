...
ZombieClasses[1] =		--I re-added this class to add some diversity into the game. We need faster classes				
{
	...
	Speed = 140,	
	AngleFix = true,
	DescriptionGameplay = { "> PRIMARY: Claws", "> SECONDARY: Throw flesh","> RELOAD: Create blood spawner on ground", "> FLESH: 10 health to zombies, 5 damage to props and humans", "> CLAW POISON: 10 | 2 per 1.5 seconds", "> HEALTH: 100 ", "> SPEED: 148", "> DAMAGE: 10" },
	DescriptionGameplay2 = { "TYPE: Back bone of a horde! " },
	PainSounds = {
...
ZombieClasses[4] =
{
	...
	DescriptionGameplay = {"> PRIMARY: Claws", "> SECONDARY: Disguise as a human!", "> SPECIAL: Ignored by turrets and proximity C4", "> HEALTH: 100 ", "> SPEED: 145 / 185 ", "> DAMAGE: 20" },
...
ZombieClasses[6] =						
{
	...
	DescriptionGameplay = {"> PRIMARY: Girly claws", "> SECONDARY: Disorientating scream", "> HEALTH: 150 ", "> SPEED: 150", "> CLAW DAMAGE: 17", "> HOWL: +3 damage against berserkers" },
	DescriptionGameplay2 = { "TYPE: Support class for horde" },
	PlayerFootstep = true,
	AttackSounds = { 
